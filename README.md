...
| 08 | `08_bacteria_colony_simulator.py` | while True + break |
| 09 | `09_at_content_calculator.py` | functions, return values |
| 10 | `10_lab_centrifuge_logger.py` | default parameters |
| 11 | `11_multiple_choice_quiz.py` | lists of lists, input validation |
| 12 | `12_genetic_mutation_scanner.py` | list comparison, indexing |
| 13 | `13_rna_codon_translator.py` | dictionaries |
| 14 | `14_full_sequence_translator.py` | loop step size, dictionaries |
| 15 | `15_biological_ribosome.py` | loop + break, simulating stop codons |
| 16 | `16_lab_database.py` | dictionaries, filtering |
| 17 | `17_crash_proof_input_tool.py` | try / except |
